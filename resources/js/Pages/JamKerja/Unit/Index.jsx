...
export default function Index({ jadwals, filters, hariOptions, units }) {
  ...
  return (
    <AdminLayout title="Jadwal Unit">
            ...
            <div className="modal-dialog">
              <form className="modal-content" onSubmit={submit}>
                <div className="modal-header">
                  ...
                  <h4>{edit ? 'Edit' : 'Tambah'} Jadwal Unit</h4>
                </div>
                  ...
                  <div className="form-group">
                    ...
                    <select
                      ...
                      onChange={(e) => {
                        ...
                        setData('unit_id', value === '' ? '' : Number(value))
                      }}
                    >
      ...
      <ConfirmDeleteModal
        show={!!deleteTarget}
        title="Konfirmasi Hapus Jadwal Unit"
        message={
          <p>
        ...
        onConfirm={() => {
          ...
          router.delete(`/jam-kerja/unit/${deleteTarget.id}`, {
            preserveScroll: true,
